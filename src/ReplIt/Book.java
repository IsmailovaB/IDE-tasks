...
import java.util.List;
    public class Book {
        ...
        public static Boolean isTitleWord(String word) {
            ...
            List<String> arr = new ArrayList<>(Arrays.asList("a","an","the","and","but","for","nor","at",
                    "or","into","to","on","of","near","than","via","so","by","in","yet"));
        ...
        public void setAuthor(String author) {
            if(author.isEmpty()){
                ...
                if(author.contains(" ")){
                    ...
                    this.author = capitalize(author.substring(0,ind)) +" "+ capitalize(author.substring(ind+1));
                }else{
        ...
        public void setTitle(String title) {
            ...
            if(!title.contains(" ")){
                ...
                for(int i=0; i<arr.length; i++){
                    ...
                    if(isTitleWord(arr[i]).equals(false)){
