...
//        Lexus.mileToKm(56.999);
    ...
    public static void evaluateCar(Lexus car){
     int age = 2019-car.year;
        ...
        else if((car.mileage>=50 && car.mileage<=100) || (age>=3 && age <= 7)){
            System.out.println("Fair choise");
        }
        else if(car.mileage>=100 && car.mileage<=200){
            System.out.println("You decide");
        }
        else if(car.mileage>200){
            System.out.println("Stay away");
        }
        else{
            System.out.println("Not able to availabe");
        }
    }
